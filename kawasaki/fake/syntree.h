...
enum esyntreetype {
    ...
    est_constmapvalue,
    est_constarraylist,
    est_GOTO_stm, est_LABEL_stm, est_HOME_stm, est_TOOL_stm, est_BASE_stm, est_TYPE_stm, est_STOP_stm,
    est_SIGNAL_stm, est_signal_num_stm, est_JMOVE_stm,
    est_SWAIT_stm,
    est_STRINGS_head, est_TRANS_head,est_trans_define, est_FKFLOATs_define, est_REALS_head,
    est_strings_define, est_STRING_VAR, est_reals_define, est_const_array_list_value,
    est_SIG_stm,est_TWAIT_stm
};
...
struct GOTO_stm :public syntree_node
{
    GOTO_stm() {}
...
struct LABEL_stm :public syntree_node
{
    LABEL_stm() {}
...
struct HOME_stm :public syntree_node
{
    HOME_stm() {}
...
struct TOOL_stm :public syntree_node
{
    TOOL_stm() {}
...
struct BASE_stm :public syntree_node
{
    BASE_stm() {}
...
struct TYPE_stm :public syntree_node
{
    TYPE_stm() {}
...
struct STOP_stm :public syntree_node
{
    STOP_stm() {}
...
struct SIGNAL_stm :public syntree_node
{
    SIGNAL_stm() {}
...
struct JMOVE_stm :public syntree_node
{
    JMOVE_stm() {}
...
struct TWAIT_stm :public syntree_node
{
    TWAIT_stm() {}
...
struct SWAIT_stm :public syntree_node
{
    SWAIT_stm() {}
...
struct trans_define :public syntree_node
{
    trans_define() {}

    virtual ~trans_define() {}

    virtual esyntreetype gettype() {
        return est_trans_define;
    }
...
struct FKFLOATs_define :public syntree_node
{
    FKFLOATs_define() {}

    virtual ~FKFLOATs_define() {}

    virtual esyntreetype gettype() {
        return est_FKFLOATs_define;
    }
...
struct strings_define :public syntree_node
{
    strings_define() {}

    virtual ~strings_define() {}

    virtual esyntreetype gettype() {
        return est_strings_define;
    }
...
struct STRING_VAR :public syntree_node
{
    STRING_VAR() {}
...
struct reals_define :public syntree_node
{
    reals_define() {}

    virtual ~reals_define() {}

    virtual esyntreetype gettype() {
        return est_reals_define;
    }
...
struct SIG_stm :public syntree_node
{
    SIG_stm() {}
...
struct STRINGS_head :public syntree_node
{
    STRINGS_head() {}

    virtual ~STRINGS_head() {}

    virtual esyntreetype gettype() {
        return est_STRINGS_head;
    }

    virtual String dump(int indent) {
        String ret;
        ret += gentab(indent);
        ret += "[strings_stmt_list]:\n";
    ...
    void add_stmt(syntree_node* stmt) {
        FKLOG("strings_stmt_list add stmt %s", stmt->gettypename());
        stmtlist.push_back(stmt);
    }
    stmt_node_list stmtlist;
};

struct TRANS_head :public syntree_node
{
    TRANS_head() {}
    ...
    void add_stmt(syntree_node* stmt) {
        FKLOG("trans_stmt_list add stmt %s", stmt->gettypename());
        stmtlist.push_back(stmt);
    }
    stmt_node_list stmtlist;
};

struct REALS_head :public syntree_node
{
    REALS_head() {}
    ...
    void add_stmt(syntree_node* stmt) {
        FKLOG("reals_stmt_list add stmt %s", stmt->gettypename());
        stmtlist.push_back(stmt);
    }
    stmt_node_list stmtlist;
};
