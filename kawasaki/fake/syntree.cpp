...
#define SYN_NODE_DEF(type) \
    case type:\
        ...
        SYN_NODE_DEF(est_constarraylist)
            SYN_NODE_DEF(est_GOTO_stm)
            SYN_NODE_DEF(est_LABEL_stm)
            SYN_NODE_DEF(est_HOME_stm)
            SYN_NODE_DEF(est_TOOL_stm)
            SYN_NODE_DEF(est_BASE_stm)
            SYN_NODE_DEF(est_TYPE_stm)
            SYN_NODE_DEF(est_STOP_stm)
            SYN_NODE_DEF(est_SIGNAL_stm)
            SYN_NODE_DEF(est_JMOVE_stm)
            SYN_NODE_DEF(est_SWAIT_stm)
            SYN_NODE_DEF(est_STRINGS_head)  SYN_NODE_DEF(est_TRANS_head) SYN_NODE_DEF(est_trans_define) SYN_NODE_DEF(est_FKFLOATs_define) SYN_NODE_DEF(est_REALS_head)
            SYN_NODE_DEF(est_strings_define) SYN_NODE_DEF(est_reals_define) SYN_NODE_DEF(est_const_array_list_value)
                SYN_NODE_DEF(est_SIG_stm)
            SYN_NODE_DEF(est_TWAIT_stm)
#undef SYN_NODE_DEF
    }
    assert(0);
    return "unknow";
