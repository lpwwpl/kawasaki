// This defines the interface to the QsciLexerAs class.
//
...
#include <Qsci/qscilexer.h>
    ...
    //! \brief The QsciLexerAs class encapsulates the Scintilla Lua
    //! lexer.
    class  QsciLexerAs : public QsciLexer
    {
        Q_OBJECT
    ...
    public:
        ...
        //! Destroys the QsciLexerAs instance.
        virtual ~QsciLexerAs();
