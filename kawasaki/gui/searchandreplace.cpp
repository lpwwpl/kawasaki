...
{
    SETTINGS_SET_STRING(SETTING_FIND_REPLACE_FIND_TEXT, ui->lineFind->text(), Settings_::NoSync);
    SETTINGS_SET_BOOL(SETTING_FIND_REPLACE_REPLACE, ui->checkReplace->isChecked(), Settings_::NoSync);
    SETTINGS_SET_STRING(SETTING_FIND_REPLACE_REPLAC_TEXT, ui->lineReplace->text(), Settings_::NoSync);
    SETTINGS_SET_BOOL(SETTING_FIND_REPLACE_FORWARD, ui->radioDown->isChecked(), Settings_::NoSync);

    SETTINGS_SET_BOOL(SETTING_FIND_REPLACE_CASE_SENSITIVE, ui->checkCs->isChecked(), Settings_::NoSync);
    SETTINGS_SET_BOOL(SETTING_FIND_REPLACE_WHOLE_WORDS, ui->checkWhole->isChecked(), Settings_::NoSync);
