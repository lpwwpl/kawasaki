...
QVariant DataModel::data(const QModelIndex &index, int role) const
{
    ...
    if (role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        switch (index.column()) 
        {
            ...
            {
                return node->planBeginDate().toString(tr("yyyy.MM.dd"));
            }
            case PLANENDDATE:
            {
                return node->planEndDate().toString(tr("yyyy.MM.dd"));
            }
            case PLANDAYS_COL:
            {
            ...
            {
                return node->realBeginDate().toString(tr("yyyy.MM.dd"));
            }
            case REALENDDATE_COL:
            {
                return node->realEndDate().toString(tr("yyyy.MM.dd"));
            }
            case REALDAYS_COL:
            {
